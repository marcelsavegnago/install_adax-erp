...
sudo apt-get install -y libpng-dev libjpeg-dev libfreetype6-dev libxmlsec1-dev libsasl2-dev
sudo apt-get install -y expect-dev xfonts-75dpi xfonts-base default-jre ure libreoffice-java-common libreoffice-writer
sudo apt-get install -y fonts-symbola node-clean-css node-less texlive-fonts-extra less wkhtmltopdf
